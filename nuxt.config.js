...
export const options = {
  ...
  description:
    'hal is an immersive task-based journey that inspires people towards self-discovery and emotional maturity — gain the ability to be fully present in the moment.',
  keywords: 'hal, stress, relief',
  loading: {
